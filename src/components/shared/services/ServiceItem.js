  ...
  return (
    ...
    >
      ...
      <Link
        ...
        className="text-primary-color dark:text-white-color flex items-center gap-15px md:gap-5 flex-wrap md:flex-nowrap py-5 lg:py-30px group-hover:text-white cursor-default"
      >
        ...
        <i className="flaticon-up-right-arrow text-size-15 md:text-xl text-primary-color group-hover:text-white-color absolute md:top-[20%] top-[10%] md:top-1/2 right-5 lg:right-[55px] transition-all duration-300"></i>
      </Link>
    </div>
  );
};
